...
- `.claude/knowledge/deployment-release.md` — Vercel deploys, the `--prebuilt` workaround for the lefthook prepare script, the `VERCEL_PROJECT_PRODUCTION_URL` requirement for local builds, and the canonical-domain ownership gotcha.
