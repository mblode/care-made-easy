...
- Design foundations: a typeface, icon set, and component library that work together. Keeps your UI consistent out of the box.
- Developer tools: tools and agents for coding, converting content, and testing changes.
- Platform: shared infrastructure so you don't have to build it yourself.
...
## 18. Build to solve your own problems
...
## 19. Find the problem that bothers you
